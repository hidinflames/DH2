export const Pokedex: {[k: string]: ModdedSpeciesData} = {
		...
		beedrill: {
			...
			name: "Beedrill",
			types: ["Bug", "Poison"],
			baseStats: {hp: 65, atk: 90, def: 60, spa: 45, spd: 80, spe: 75},
		...
		beedrillmega: {
			...
			forme: "Mega",
			types: ["Bug", "Ground"],
			baseStats: {hp: 65, atk: 135, def: 70, spa: 15, spd: 80, spe: 150},
		...
		raticate: {
			...
			name: "Raticate",
			types: ["Normal"],
			baseStats: {hp: 55, atk: 96, def: 60, spa: 50, spd: 70, spe: 97},
			abilities: {0: "Run Away", 1: "Guts", H: "Hustle"},
			heightm: 0.7,
			weightkg: 18.5,
			color: "Brown",
		...
		raticatealola: {
			...
			forme: "Alola",
			types: ["Dark", "Normal"],
			baseStats: {hp: 75, atk: 71, def: 70, spa: 40, spd: 90, spe: 77},
			abilities: {0: "Gluttony", 1: "Hustle", H: "Thick Fat"},
			heightm: 0.7,
			weightkg: 25.5,
			color: "Black",
		...
		arbok: {
			...
			name: "Arbok",
			types: ["Poison", "Dark"],
			baseStats: {hp: 70, atk: 110, def: 89, spa: 65, spd: 94, spe: 80},
			abilities: {0: "Intimidate", 1: "Shed Skin", H: "Unnerve"},
			heightm: 3.5,
			weightkg: 65,
			color: "Purple",
		...
		raichu: {
			...
			name: "Raichu",
			types: ["Electric"],
			baseStats: {hp: 60, atk: 110, def: 55, spa: 90, spd: 80, spe: 110},
			abilities: {0: "Static", H: "Lightning Rod"},
			heightm: 0.8,
			weightkg: 30,
			color: "Yellow",
		...
		raichualola: {
			...
			baseStats: {hp: 60, atk: 85, def: 55, spa: 110, spd: 85, spe: 110},
		...
		sandslash: {
			...
			name: "Sandslash",
			types: ["Ground"],
			baseStats: {hp: 75, atk: 110, def: 110, spa: 45, spd: 65, spe: 80},
			abilities: {0: "Sand Veil", H: "Sand Rush"},
			heightm: 1,
			weightkg: 29.5,
			color: "Yellow",
		...
		sandslashalola: {
			...
			forme: "Alola",
			types: ["Ice", "Steel"],
			baseStats: {hp: 75, atk: 110, def: 120, spa: 25, spd: 75, spe: 80},
			abilities: {0: "Snow Cloak", 1: "Slush Rush", H: "Ice Scales"},
			heightm: 1.2,
			weightkg: 55,
			color: "Blue",
		...
		nidoking: {
			...
			types: ["Poison", "Ground"],
			gender: "M",
			baseStats: {hp: 81, atk: 102, def: 77, spa: 95, spd: 75, spe: 85},
			abilities: {0: "Poison Point", 1: "Rivalry", H: "Sheer Force"},
			heightm: 1.4,
			weightkg: 62,
			color: "Purple",
		...
		vileplume: {
			...
			abilities: {0: "Chlorophyll", 1: "Effect Spore", H: "Regenerator"},
			heightm: 1.2,
			weightkg: 18.6,
			color: "Red",
			prevo: "Gloom",
		...
		parasect: {
			...
			name: "Parasect",
			types: ["Bug"],
			baseStats: {hp: 75, atk: 95, def: 95, spa: 60, spd: 95, spe: 30},
		...
		venomoth: {
			...
			name: "Venomoth",
			types: ["Bug", "Poison"],
			baseStats: {hp: 70, atk: 65, def: 70, spa: 100, spd: 85, spe: 100},
		...
		persian: {
			...
			name: "Persian",
			types: ["Normal"],
			baseStats: {hp: 65, atk: 85, def: 70, spa: 65, spd: 65, spe: 115},
			abilities: {0: "Limber", 1: "Technician", H: "Opportunist"},
			heightm: 1,
			weightkg: 32,
			color: "Yellow",
			prevo: "Meowth",
		...
		persianalola: {
			...
			forme: "Alola",
			types: ["Dark"],
			baseStats: {hp: 65, atk: 60, def: 70, spa: 85, spd: 65, spe: 115},
			abilities: {0: "Fur Coat", 1: "Technician", H: "Opportunist"},
			heightm: 1.1,
			weightkg: 33,
			color: "Blue",
			prevo: "Meowth-Alola",
		...
		golduck: {
			...
			abilities: {0: "Competitive", 1: "Cloud Nine", H: "Swift Swim"},
			heightm: 1.7,
			weightkg: 76.6,
			color: "Blue",
			prevo: "Psyduck",
		...
		victreebel: {
			...
			name: "Victreebel",
			types: ["Grass", "Poison"],
			baseStats: {hp: 80, atk: 105, def: 65, spa: 110, spd: 70, spe: 80},
			abilities: {0: "Chlorophyll", H: "Sheer Force"},
			heightm: 1.7,
			weightkg: 15.5,
			color: "Green",
			prevo: "Weepinbell",
		...
		golem: {
			...
			name: "Golem",
			types: ["Rock", "Ground"],
			baseStats: {hp: 80, atk: 120, def: 130, spa: 45, spd: 75, spe: 55},
			abilities: {0: "Rock Head", 1: "Sturdy", H: "Sand Veil"},
			heightm: 1.4,
			weightkg: 300,
			color: "Brown",
		...
		golemalola: {
			...
			forme: "Alola",
			types: ["Rock", "Electric"],
			baseStats: {hp: 80, atk: 120, def: 130, spa: 45, spd: 65, spe: 60},
			abilities: {0: "Magnet Pull", 1: "Sturdy", H: "Galvanize"},
			heightm: 1.7,
			weightkg: 316,
			color: "Gray",
		...
		dodrio: {
			...
			abilities: {0: "Tough Claws", 1: "Early Bird", H: "Tangled Feet"},
			heightm: 1.8,
			weightkg: 85.2,
			color: "Brown",
			prevo: "Doduo",
		...
		dewgong: {
			...
			abilities: {0: "Thick Fat", 1: "Hydration", H: "Fur Coat"},
			heightm: 1.7,
			weightkg: 120,
			color: "White",
			prevo: "Seel",
		...
		hypno: {
			...
			name: "Hypno",
			types: ["Psychic"],
			baseStats: {hp: 85, atk: 73, def: 75, spa: 103, spd: 115, spe: 69},
			abilities: {0: "Insomnia", 1: "Prankster", H: "Inner Focus"},
			heightm: 1.6,
			weightkg: 75.6,
			color: "Yellow",
			prevo: "Drowzee",
		...
		kingler: {
			...
			name: "Kingler",
			types: ["Water"],
			baseStats: {hp: 55, atk: 130, def: 115, spa: 50, spd: 50, spe: 85},
			abilities: {0: "Hyper Cutter", 1: "Shell Armor", H: "Sheer Force"},
			heightm: 1.3,
			weightkg: 60,
			color: "Red",
		...
		exeggutoralola: {
			...
			abilities: {0: "Frisk", 1: "Mold Breaker", H: "Harvest"},
			heightm: 10.9,
			weightkg: 415.6,
			color: "Yellow",
			prevo: "Exeggcute",
		...
		marowak: {
			...
			name: "Marowak",
			types: ["Ground"],
			baseStats: {hp: 75, atk: 80, def: 110, spa: 50, spd: 80, spe: 65},
			abilities: {0: "Rock Head", 1: "Lightning Rod", H: "Battle Armor"},
			heightm: 1,
			weightkg: 45,
			color: "Brown",
		...
		mrmime: {
			...
			name: "Mr. Mime",
			types: ["Psychic", "Fairy"],
			baseStats: {hp: 50, atk: 45, def: 65, spa: 115, spd: 120, spe: 90},
			abilities: {0: "Soundproof", 1: "Protean", H: "Technician"},
			heightm: 1.3,
			weightkg: 54.5,
			color: "Pink",
			prevo: "Mime Jr.",
		...
		mrmimegalar: {
			...
			forme: "Galar",
			types: ["Ice", "Psychic"],
			baseStats: {hp: 60, atk: 65, def: 65, spa: 105, spd: 90, spe: 100},
		...
		pinsir: {
			...
			name: "Pinsir",
			types: ["Bug"],
			baseStats: {hp: 65, atk: 125, def: 100, spa: 55, spd: 70, spe: 90},
		...
		pinsirmega: {
			...
			forme: "Mega",
			types: ["Bug", "Flying"],
			baseStats: {hp: 65, atk: 155, def: 120, spa: 65, spd: 90, spe: 110},
		...
		aerodactylmega: {
			...
			types: ["Rock", "Flying"],
			genderRatio: {M: 0.875, F: 0.125},
			baseStats: {hp: 80, atk: 130, def: 90, spa: 70, spd: 95, spe: 150},
			abilities: {0: "Tough Claws"},
			heightm: 2.1,
			weightkg: 79,
			color: "Purple",
		...
		furret: {
			...
			name: "Furret",
			types: ["Normal"],
			baseStats: {hp: 85, atk: 96, def: 74, spa: 45, spd: 75, spe: 100},
		...
		noctowl: {
			...
			name: "Noctowl",
			types: ["Normal", "Flying"],
			baseStats: {hp: 100, atk: 50, def: 50, spa: 106, spd: 96, spe: 80},
			abilities: {0: "Insomnia", 1: "Keen Eye", H: "Tinted Lens"},
			heightm: 1.6,
			weightkg: 40.8,
			color: "Brown",
		...
		ledian: {
			...
			abilities: {0: "Swarm", 1: "Early Bird", H: "Zero to Hero (Ledian)"},
			heightm: 1.4,
			weightkg: 35.6,
			color: "Red",
			prevo: "Ledyba",
		...
		ariados: {
			...
			name: "Ariados",
			types: ["Bug", "Poison"],
			baseStats: {hp: 70, atk: 110, def: 70, spa: 100, spd: 70, spe: 65},
			abilities: {0: "Swarm", 1: "Insomnia", H: "Merciless"},
			heightm: 1.1,
			weightkg: 33.5,
			color: "Red",
			prevo: "Spinarak",
		...
		lanturn: {
			...
			name: "Lanturn",
			types: ["Water", "Electric"],
			baseStats: {hp: 125, atk: 58, def: 63, spa: 96, spd: 96, spe: 67},
			abilities: {0: "Volt Absorb", 1: "Illuminate", H: "Wonder Skin"},
			heightm: 1.2,
			weightkg: 22.5,
			color: "Blue",
			prevo: "Chinchou",
		...
		xatu: {
			...
			name: "Xatu",
			types: ["Psychic", "Flying"],
			baseStats: {hp: 85, atk: 75, def: 85, spa: 95, spd: 75, spe: 95},
			abilities: {0: "Synchronize", 1: "Early Bird", H: "Magic Bounce"},
			heightm: 1.5,
			weightkg: 15,
			color: "Green",
		...
		azumarill: {
			...
			name: "Azumarill",
			types: ["Water", "Fairy"],
			baseStats: {hp: 100, atk: 50, def: 80, spa: 60, spd: 80, spe: 60},
			abilities: {0: "Thick Fat", 1: "Huge Power", H: "Sap Sipper"},
			heightm: 0.8,
			weightkg: 28.5,
			color: "Blue",
		...
		sudowoodo: {
			...
			name: "Sudowoodo",
			types: ["Rock"],
			baseStats: {hp: 70, atk: 110, def: 115, spa: 30, spd: 65, spe: 75},
		...
		jumpluff: {
			...
			name: "Jumpluff",
			types: ["Grass", "Flying"],
			baseStats: {hp: 75, atk: 60, def: 70, spa: 55, spd: 95, spe: 110},
			abilities: {0: "Chlorophyll", 1: "Own Spirit", H: "Infiltrator"},
			heightm: 0.8,
			weightkg: 3,
			color: "Blue",
			prevo: "Skiploom",
		...
		sunflora: {
			...
			name: "Sunflora",
			types: ["Grass"],
			baseStats: {hp: 75, atk: 75, def: 55, spa: 105, spd: 85, spe: 60},
			abilities: {0: "Chlorophyll", 1: "Solar Power", H: "Early Bird"},
			heightm: 0.8,
			weightkg: 8.5,
			color: "Yellow",
		...
		quagsire: {
			...
			name: "Quagsire",
			types: ["Water", "Ground"],
			baseStats: {hp: 110, atk: 85, def: 100, spa: 65, spd: 65, spe: 35},
			abilities: {0: "Damp", 1: "Water Absorb", H: "Unaware"},
			heightm: 1.4,
			weightkg: 75,
			color: "Blue",
		...
		unown: {
			...
			abilities: {0: "Levitate", S: "Ancient Awakening"},
			heightm: 0.5,
			weightkg: 5,
			color: "Black",
			eggGroups: ["Undiscovered"],
		...
		unowncomplete: {
			...
			types: ["Psychic"],
			gender: "N",
			baseStats: {hp: 144, atk: 126, def: 96, spa: 126, spd: 96, spe: 96},
			abilities: {0: "Ancient Awakening"},
			heightm: 13.21,
			weightkg: 129,
			color: "Black",
			eggGroups: ["Undiscovered"],
		...
		corsola: {
			...
			types: ["Water", "Rock"],
			genderRatio: {M: 0.25, F: 0.75},
			baseStats: {hp: 85, atk: 55, def: 100, spa: 80, spd: 100, spe: 35},
		...
		corsolagalar: {
			...
			types: ["Ghost"],
			genderRatio: {M: 0.25, F: 0.75},
			baseStats: {hp: 75, atk: 55, def: 100, spa: 90, spd: 100, spe: 35},
		...
		octillery: {
			...
			name: "Octillery",
			types: ["Water"],
			baseStats: {hp: 75, atk: 110, def: 75, spa: 110, spd: 75, spe: 65},
		...
		delibird: {
			...
			name: "Delibird",
			types: ["Ice", "Flying"],
			baseStats: {hp: 45, atk: 55, def: 45, spa: 65, spd: 45, spe: 85},
