...
// List of flags and their descriptions can be found in sim/dex-moves.ts
	...
	cracklesmash: {
		...
		basePower: 60,
		category: "Physical",
		shortDesc: "User in Electric Terrain: +1 priority.",
		name: "Crackle Smash",
		pp: 10,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, metronome: 1},
	...
	kamikaze: {
		...
		basePower: 250,
		category: "Physical",
		shortDesc: "Hits adajacent Pokemon. The user faints.",
		name: "Kamikaze",
		pp: 5,
		priority: 0,
		flags: {protect: 1, mirror: 1, metronome: 1, noparentalbond: 1},
	...
	fielddestruction: {
		...
		basePower: 130,
		category: "Physical",
		shortDesc: "Clears terrain, hazards, and substitutes on both sides; Has 33% recoil.",
	...
	buzzout: {
		...
		basePower: 0,
		category: "Status",
		shortDesc: "Raises highest non-Spe stat by 3. Cannot be used twice in battle.",
		name: "Buzz Out",
		pp: 10,
		priority: 0,
		flags: {metronome: 1, cantusetwice: 1},
		onHit(target) {
			const stats: BoostID[] = [];
	...
	meltdown: {
		...
		basePower: 100,
		category: "Special",
		shortDesc: "Raises Speed by 2, lowers Defense by 1.",
		name: "Meltdown",
		pp: 5,
		priority: 0,
		flags: {protect: 1, mirror: 1, metronome: 1},
	...
	evaporate: {
		...
		basePower: 70,
		category: "Physical",
		shortDesc: "Super effective on Water. 10% chance to burn the target.",
		name: "Evaporate",
		pp: 20,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, metronome: 1},
	...
	psycheout: {
		...
		basePower: 40,
		category: "Special",
		shortDesc: "Usually goes first; usable in Psychic Terrain.",
		name: "Psyche Out",
		pp: 30,
		priority: 1,
		flags: {protect: 1, mirror: 1, metronome: 1},
	...
	pixiebreak: {
		...
		accuracy: 100,
		category: "Physical",
		shortDesc: "Neutral damage on Fairy.",
		name: "Pixie Break",
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1},
	...
	faeoverload: {
		...
		basePower: 120,
		category: "Physical",
		shortDesc: "Lowers the user's Def and Sp. Def by 1.",
		name: "Fae Overload",
		pp: 5,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, metronome: 1},
	...
	secretwillpower: {
		...
		basePower: 80,
		category: "Special",
		shortDesc: "Damages target based on Special Defense.",
		overrideDefensiveStat: 'def',
		name: "Secret Willpower",
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1, metronome: 1},
		secondary: null,
	...
	piercingspike: {
		...
		basePower: 75,
		category: "Physical",
		shortDesc: "20% to paralyze the target.",
		name: "Piercing Spike",
		pp: 15,
		priority: 0,
		flags: {protect: 1, mirror: 1, nonsky: 1, metronome: 1},
	...
	deposition: {
		...
		basePower: 0,
		category: "Status",
		shortDesc: "User restores 1/2 HP; frees user's side from hazards.",
		name: "Deposition",
		pp: 5,
		priority: 0,
		flags: {snatch: 1, heal: 1, metronome: 1},
		onHit(target, source, move) {
			let success = false;
			const removeSideCondition = [
				'spikes', 'toxicspikes', 'stealthrock', 'stickyweb', 'gmaxsteelsurge',
			];
			for (const sideCondition of removeAll) {
				if (source.side.removeSideCondition(sideCondition)) {
					this.add('-sideend', source.side, this.dex.conditions.get(sideCondition).name, '[from] move: Deposition', '[of] ' + source);
					success = true;
				}
			}
		},
	...
	woodypunch: {
		...
		basePowerCallback(source, target, move) {
			if (this.field.isTerrain('grassyterrain')) {
				if (!source.isAlly(target)) this.hint(`${move.name}'s BP doubled in Grassy Terrain.`);
				return move.basePower * 2;
			}
			return move.basePower;
		},
		category: "Physical",
		shortDesc: "Double damage under Grassy Terrain.",
		name: "Woody Punch",
		pp: 10,
		priority: 0,
	...
	flicker: {
		...
		basePower: 0,
		category: "Status",
		shortDesc: "Raises the user's Special Attack by 2.",
		name: "Flicker",
		pp: 20,
		priority: 0,
		flags: {snatch: 1, metronome: 1},
	...
	forestsguard: {
		...
		basePower: 0,
		category: "Status",
		shortDesc: "For 5 turns, damage to allies is halved. Grassy Terrain only. 8 turns if holding Light Clay.",
		name: "Forest's Guard",
		pp: 20,
		priority: 0,
		flags: {snatch: 1, metronome: 1},
		sideCondition: 'forestsguard',
		onTry() {
		...
		condition: {
			...
			onAnyModifyDamage(damage, source, target, move) {
				if (target !== source && this.effectState.target.hasAlly(target)) {
					...
					if (!target.getMoveHitData(move).crit && !move.infiltrates) {
						this.debug('Forests Guard weaken');
						if (this.activePerHalf > 1) return this.chainModify([2732, 4096]);
						return this.chainModify(0.5);
					}
				}
			...
			onSideStart(side) {
				this.add('-sidestart', side, 'move: Forests Guard');
			},
			onSideResidualOrder: 26,
			onSideResidualSubOrder: 10,
			onSideEnd(side) {
				this.add('-sideend', side, 'move: Forests Guard');
			},
		},
		secondary: null,
		target: "allySide",
	...
	transcendinghit: {
		...
		basePower: 50,
		category: "Physical",
		shortDesc: "50% chance to raise Speed by 1.",
		name: "Transcending Hit",
		pp: 10,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1},
		secondary: {
	...
	gradientgrasp: {
		...
		basePower: 95,
		category: "Physical",
		shortDesc: "20% chance to lower targets Defense by 1.",
		name: "Gradient Grasp",
		pp: 15,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, metronome: 1},
	...
	electrocution: {
		...
		basePower: 85,
		category: "Special",
		shortDesc: "Eliminates all stat changes. 1.5x damage to stat boosted foes.",
		name: "Electrocution",
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1},
	...
	dauntingroar: {
		...
		basePower: 100,
		category: "Special",
		shortDesc: "Eliminates all stat changes. Hits adjacent foe(s).",
		name: "Daunting Roar",
		pp: 5,
		priority: 0,
		flags: {protect: 1, mirror: 1, sound: 1},
	...
	whimsyray: {
		...
		basePower: 85,
		category: "Special",
		shortDesc: "20% chance to confuse. Hits adjacent foe(s).",
		name: "Whimsy Ray",
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1, metronome: 1},
	...
	streamsummon: {
		...
		basePower: 0,
		category: "Status",
		shortDesc: "For 5 turns, very windy streams begin.",
		name: "Stream Summon",
		pp: 5,
		priority: 0,
		flags: {metronome: 1},
